...
const team: TeamMember[] = [
  {
    name: "ندى المطيري",
    major: "نظم معلومات",
    description: "تصميم تجربة المستخدم وربط الواجهة بفكرة المنتج واحتياج المستخدم.",
  ...
  },
  {
    ...
    description: "تحليل الجانب المالي وتحويل بيانات الاشتراكات إلى قرارات واضحة.",
    tags: ["Finance", "Backend", "Analysis"],
    image: shadenPhoto,
    imageClass: "dl-team-photo-cover dl-team-photo-zoom-strong",
  },
  {
    name: "سندس الربيش",
    major: "هندسة كهرباء واتصالات",
    description: "دعم بناء الأنظمة واختبار التجربة وتدفق البيانات بشكل موثوق.",
  ...
  },
  {
    name: "رهف الحارثي",
    major: "كيمياء",
    description: "البحث والتوثيق وتنظيم تفاصيل المشروع وصياغة المحتوى بدقة.",
  ...
  },
  {
    name: "ريناد الزعيبر",
    major: "علوم حاسب",
    description: "بناء قاعدة البيانات وربط الخدمات التقنية وتحسين منطق النظام.",
    tags: ["Backend", "DB", "API"],
    image: renadPhoto,
  },
];
...
const subscriptions = [
  { name: "Netflix", category: "ترفيه", price: "95 ر.س", date: "15 مايو", logo: netflixLogo },
  { name: "Spotify", category: "موسيقى", price: "27 ر.س", date: "20 مايو", logo: spotifyLogo },
  { name: "Canva Pro", category: "تصميم", price: "39 ر.س", date: "24 مايو", logo: canvaLogo },
  { name: "Adobe", category: "أدوات تصميم", price: "198 ر.س", date: "28 مايو", logo: adobeLogo },
];
  ...
  return (
    <div className="dl-preview-wrap" aria-label="معاينة لوحة تحكم ديرها">
      <div className="dl-credit-card" aria-hidden="true">
        ...
        <small>4548</small>
        <span className="dl-valid-date">VALID THRU<br />06/28</span>
      </div>
      ...
      <div className="dl-dashboard-card">
        ...
        <div className="dl-dashboard-content">
          <div className="dl-dashboard-heading">
            ...
            <button type="button" className="dl-hero-bell" aria-label="التنبيهات">
          ...
          <div className="dl-dashboard-metrics">
            <div><span>إجمالي المصروفات</span><b>386</b><small>ريال هذا الشهر</small></div>
            <div><span>اشتراكات نشطة</span><b>8</b><small>اشتراكات</small></div>
            <div><span>القادم للتجديد</span><b>1,248</b><small>ريال خلال الشهر</small></div>
          </div>
          ...
          <div className="dl-subscriptions-list">
            {subscriptions.map((subscription) => (
              <div className="dl-subscription-row" key={subscription.name}>
    ...
    <div className="dierha-landing-page" dir="rtl">
      <header className="dl-header">
        <div className="dl-container dl-nav-wrap">
          ...
          <a className="dl-header-cta" href="/login">ابدأ الآن ←</a>
        </div>
      </header>
        ...
        <section className="dl-hero" id="home">
          <div className="dl-container dl-hero-grid">
            ...
            <div className="dl-hero-copy">
              ...
              <h1>اشتراكاتك أوضح<br />ومصاريفك <span>أذكى</span></h1>
              <p>
                اجمع اشتراكاتك في مكان واحد، تابع مواعيد التجديد،
                وافهم مصروفاتك الشهرية بوضوح وهدوء.
              </p>
              <div className="dl-hero-actions">
                <a className="dl-btn dl-btn-primary" href="/login">ابدأ الآن</a>
                <a className="dl-btn dl-btn-secondary" href="#features">استعرض المزايا</a>
              </div>
            ...
            <div className="dl-feature-grid">
              {features.map((feature) => (
                <article className="dl-feature-card" key={feature.title}>
                  <span className={`dl-feature-icon ${feature.tone}`}>{feature.icon}</span>
                  <div>
                    <h3>{feature.title}</h3>
        ...
        <section className="dl-section dl-story-section" id="story">
          <div className="dl-container dl-story-grid">
            <div className="dl-story-copy">
              ...
              <p>
                مع كثرة الاشتراكات الشهرية صار من السهل ننسى خدمة ما نستخدمها
                أو نتفاجأ بتجديد جديد. ديرها جاءت عشان تجمع الاشتراكات في مكان
                واحد وتخلي القرار المالي أوضح.
              </p>
              <p>
                الفكرة بسيطة: تضيفين الاشتراك يدويًا، تحددين تاريخ التجديد،
                وتتابعين المصروفات والتنبيهات بدون مشاركة بياناتك البنكية.
              </p>
              <a href="/login" className="dl-text-link">جرّب ديرها الآن ←</a>
            </div>

            <div className="dl-story-visual">
              <span className="dl-story-blob" />
              <div className="dl-woman-frame">
                <img src={heroWoman} alt="مستخدمة مبتسمة تتصفح هاتفها" />
              </div>
        ...
        <section className="dl-section dl-how-section" id="how">
          <div className="dl-container">
            <div className="dl-section-heading">
              ...
              <p>أربع خطوات واضحة تساعدك تفهمين اشتراكاتك وتتحكمين فيها.</p>
            </div>
        ...
        <section className="dl-section dl-insight-section">
          <div className="dl-container dl-insight-grid">
            <div className="dl-insight-copy">
              ...
              <p>
                نمنحك أرقامًا سهلة القراءة تساعدك على إدارة اشتراكاتك بثقة،
                ومعرفة أين تذهب مصروفاتك كل شهر.
              </p>
            ...
            <div className="dl-insight-panel">
              <div className="dl-ring-chart"><span>78%</span></div>
              <div className="dl-insight-stat"><small>إجمالي المصروفات</small><strong>386 ريال</strong></div>
              <div className="dl-insight-stat"><small>الأقرب للتجديد</small><strong>بعد 3 أيام</strong></div>
              <div className="dl-insight-stat"><small>الأكثر استخدامًا</small><strong>Netflix</strong></div>
            </div>
          </div>
        </section>
        ...
        <section className="dl-section dl-why-section">
          <div className="dl-container dl-why-box">
            ...
            <div>
              ...
              <h2>لماذا ديرها؟</h2>
              <p>
                كثير من الاشتراكات تتجدد تلقائيًا دون أن نلاحظ، وتسبب مصاريف
                غير ضرورية. ديرها تمنحك الوضوح والتنبيهات والتحكم الكامل حتى
                تكون قراراتك المالية أوضح.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="dl-section dl-team-section" id="team">
          <div className="dl-container">
            <div className="dl-section-heading">
              ...
              <p>فريق جمع بين التصميم والتطوير والتحليل لتحويل ديرها إلى تجربة رقمية واضحة.</p>
            </div>
        ...
        <section className="dl-section dl-cta-section">
          <div className="dl-container dl-cta-box">
            <div>
              ...
              <p>تابع التجديدات والمصروفات والتنبيهات من مكان واحد.</p>
            </div>
      ...
      <footer className="dl-footer">
        <div className="dl-container dl-footer-grid">
          <div className="dl-footer-brand">
            <img src={dierhaLogo} alt="ديرها" />
            <p>ديرها يساعدك على تنظيم اشتراكاتك ومتابعة مصروفاتك ومواعيد التجديد بسهولة.</p>
          </div>
          <div>
            <h4>روابط سريعة</h4>
        ...
        <div className="dl-container dl-copyright">© 2026 ديرها — جميع الحقوق محفوظة</div>
      </footer>
    </div>
  );
}
