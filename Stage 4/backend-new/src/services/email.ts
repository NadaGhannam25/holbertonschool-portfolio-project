...
const EMAIL_STYLES = `
  ...
  .wrapper {
    ...
    box-shadow: 0 18px 45px rgba(102,108,192,0.12);
  }

  .header {
    background: linear-gradient(135deg, #666CC0 0%, #6E87C0 45%, #F9E1B3 100%);
  ...
  .card {
    ...
    padding: 35px;
    margin: 38px 0;
    box-shadow: 0 6px 16px rgba(102,108,192,0.05);
  }
  ...
  .btn-primary {
    ...
    font-size: 16px;
    font-weight: 800;
    box-shadow: 0 12px 24px rgba(102,108,192,0.28);
  }

  .btn-secondary {
    display: inline-block;
    background: linear-gradient(135deg, #F9E1B3, #F9E1B3);
        ...
        data.cancelUrl
          ? `
            <p style="text-align:center !important; margin-top:28px;">
              <a href="${data.cancelUrl}" class="btn-secondary">
                إلغاء الاشتراك
              </a>
            </p>
          `
